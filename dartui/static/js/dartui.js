...
var downloadIcon = $('<svg version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="35px" height="35px" viewBox="0 0 35 35" overflow="inherit" xml:space="preserve"><circle id="toggle_color" cx="17.5" cy="17.5" r="17.5"/><g id="download_x5F_alt_1_"><g><path fill="#FFFFFF" d="M10.29,14.07c-0.145-0.188-0.068-0.352,0.169-0.352h4.291V4.948c0-0.238,0.24-0.449,0.478-0.449h4.605c0.237,0,0.408,0.21,0.408,0.449v8.771h4.374c0.237,0,0.311,0.163,0.166,0.352l-6.98,8.106c-0.145,0.188-0.383,0.188-0.528-0.001L10.29,14.07z"/></g><g><path fill="#FFFFFF" d="M28.006,21.915h-0.422h-1.375H8.756H8.333H6.958c-0.252,0-0.458,0.207-0.458,0.459v2.327v1.339v0.459h0.458h1.834h17.417h1.832H28.5V26.04v-1.339v-2.327C28.5,22.122,28.258,21.915,28.006,21.915z M26.666,24.665h-1.832v-0.916h1.832V24.665z"/></g></g></svg>');
...
function buildHeader(hideIcons) {
	...
	icons.append(changeIconColor(downloadIcon, iconColorIdle));
